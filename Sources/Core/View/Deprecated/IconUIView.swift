...
@available(*, deprecated, message: "Use SparkUIIcon instead")
public final class IconUIView: UIView {
    ...
    private let viewModel: IconViewModelDeprecated
    ...
    public init(
        ...
        self.viewModel = IconViewModelDeprecated(theme: theme, intent: intent, size: size)
